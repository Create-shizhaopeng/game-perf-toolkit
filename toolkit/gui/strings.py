...
TITLEBAR_MENU_OUTPUT_DIR: Final = "输出目录"
DLG_OUTPUT_DIR_TITLE: Final = "选择输出目录"
DLG_OUTPUT_DIR_SUCCESS_FMT: Final = "输出目录已更新为: {dir}"
DLG_OUTPUT_DIR_RESET_FMT: Final = "输出目录已重置为默认: {dir}"
MIGRATION_DLG_TITLE: Final = "数据迁移"
MIGRATION_DLG_MSG: Final = "检测到您可能从旧版便携包升级。是否迁移旧版数据到新位置？"
MIGRATION_DLG_BROWSE: Final = "浏览旧版目录"
MIGRATION_DLG_MIGRATE: Final = "迁移"
MIGRATION_DLG_SKIP: Final = "跳过"
MIGRATION_DLG_INVALID: Final = "所选目录无效：缺少 data/ 子目录"
MIGRATION_DLG_PROGRESS_FMT: Final = "正在迁移 ({done}/{total}): {file}"
MIGRATION_DLG_SUCCESS_FMT: Final = "迁移完成：{migrated} 项迁移，{skipped} 项跳过"
MIGRATION_DLG_FAILED_FMT: Final = "迁移完成：{migrated} 项迁移，{failed} 项失败"
MIGRATION_DLG_NO_SOURCE: Final = "未选择旧版目录"
