...
| 条目 | spec 要求 | 实现 | 状态 |
|------|-----------|------|------|
| FR-001 路径 | 开发 `modules/.../data/device_info.json`；frozen `exe/data/device_info.json` | `resolve_device_info_json_path()` | OK |
...
| 回退打包 | 不打入默认档案 | `_collect_device_disguise_data` 已移除 | OK |
