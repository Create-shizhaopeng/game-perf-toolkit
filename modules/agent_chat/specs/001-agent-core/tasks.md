...
- [Phase 3: GUI Agent Tab](#phase-3-gui-agent-tab)
  - [3.1 基础聊天界面](#31-基础聊天界面)
  - [3.2 消息区域](#32-消息区域)
  - [3.3 输入区域 + 异步执行](#33-输入区域--异步执行)
  - [3.4 会话历史管理](#34-会话历史管理)
  - [3.5 SOP 管理面板](#35-sop-管理面板)
  - [3.6 设置弹窗](#36-设置弹窗)
  - [3.7 对话持久化集成](#37-对话持久化集成)
- [Phase 4: 单项分析能力适配](#phase-4-单项分析能力适配)
  - [4.1 Perfetto Analysis 适配](#41-perfetto-analysis-适配)
  - [4.2 PerfDog Insights 适配](#42-perfdog-insights-适配)
  - [4.3 Game Perf 适配](#43-game-perf-适配)
...
- [依赖与执行顺序](#依赖与执行顺序)
  ...
  - [并行机会](#并行机会)
  - [推荐实施策略（单人）](#推荐实施策略单人)
- [Spec Phase → Plan Phase 映射](#spec-phase--plan-phase-映射)
- [Success Criteria 验证](#success-criteria-验证)
