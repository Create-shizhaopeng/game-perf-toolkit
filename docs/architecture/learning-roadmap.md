...
- [1. 本项目涉及的核心概念](#1-本项目涉及的核心概念)
  ...
  - [1.4 MCP Server 与 Skill](#14-mcp-server-与-skill)
...
- [3. 具体技术栈学习材料](#3-具体技术栈学习材料)
  ...
  - [3.2 MCP Server 与 Skill Registry](#32-mcp-server-与-skill-registry)
